...
class TestBasic(unittest.TestCase):
    def test_basic_parse(self):
        data = puzzle.parse(open(r"C:\Users\user\source\repos\advent-of-code-2019\day6\testinput.txt", "r").readlines())
        self.assertEqual([['LH2', 'LD6'], ['SSV', 'S13']], data)

    def test_basic_solve(self):
        data = [['B', 'C'], ['C', 'D'], ['B', 'G']]
        self.assertEqual(4, puzzle.solve(data)[0].name)
